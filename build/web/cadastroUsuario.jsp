<%-- 
    ...
    Created on : 05/08/2016, 14:56:24
    Author     : Edilva
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" style="width:60%">
            <div class="row">
                <form method="post" id="cadastroUsuario" action="Controller?command=CadastrarUsuario" name="formUsuario">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="tipo" id="tipo" onchange="this.value==='GERENTE_DE_AGENCIA' ? agencia.disabled=false : agencia.disabled=true;">
                            ...
                            <option value="GERENTE_GERAL_DO_BANCO">Gerente Geral do Banco</option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="tipo">Agencia: </label>
                        <select class="form-control" name="agencia" id="agencia" disabled="true">
