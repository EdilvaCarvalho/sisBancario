<%-- 
    Document   : cadastroAgencia
    Created on : 05/08/2016, 14:18:36
    Author     : Edilva
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h1>Dados da Agência</h1>
            <br>
        </div>
        <div class="container" style="width:60%">
            <div class="row">
                <form method="post" id="cadastroAgencia" action="Controller?command=CadastrarAgencia">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" name="numero" id="numero" min="1" title="O número nínimo é 1" required>
                    </div>
                    <div class="form-group col-md-4">
